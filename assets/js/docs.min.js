...
!function(t){"use strict";t(function(){t('[data-toggle="popover"]').popover(),t(".highlight").each(function(){var o='<div class="docs-clipboard"><span class="btn-clipboard" title="Copy to clipboard">Copy</span></div>';t(this).before(o),t(".btn-clipboard").tooltip()});var o=new Clipboard(".btn-clipboard",{target:function(t){return t.parentNode.nextElementSibling}});o.on("success",function(o){t(o.trigger).attr("title","Copied!").tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle"),o.clearSelection()}),o.on("error",function(o){var i=/Mac/i.test(navigator.userAgent)?"Press ⌘ + C to copy":"Press Ctrl + C to copy";t(o.trigger).attr("title",i).tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle")})})}(jQuery),function(){"use strict";anchors.options.placement="left",anchors.add(".docs-content > h1, .docs-content > h2, .docs-content > h3, .docs-content > h4, .docs-content > h5")}();